CREATE SCHEMA IF NOT EXISTS `hw_001` ;

CREATE TABLE IF NOT EXISTS `hw_001`.`phone_base` (
...
INSERT INTO `hw_001`.`phone_base` (`Product_name`, `Manufacturer`, `Product_count`, `Price`) VALUES ('Calaxy S9', 'Samsung', '2', '56000');
INSERT INTO `hw_001`.`phone_base` (`Product_name`, `Manufacturer`, `Product_count`, `Price`) VALUES ('Galaxy S8', 'Samsung', '1', '41000');
INSERT INTO `hw_001`.`phone_base` (`Product_name`, `Manufacturer`, `Product_count`, `Price`) VALUES ('P20 Pro', 'Huawei', '5', '36000');
